  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
		...
		if(($text == "อุณหภูมิตอนนี้")||($text == "อุณหภูมิวันนี้")||($text == "อุณหภูมิ")){
			...
			$reply_message = 'ชื่อนายฐิติพงศ์ อ่อนจันทร์ อายุ 22ปี น้ำหนัก 52kg. สูง 180cm. ขนาดรองเท้าเบอร์ 6 ใช้หน่วย US';
		}
	   	else if(($text== "อยากทราบยอด COVID-19 ครับ") || ($text== "COVID-19") || ($text== "COVID-19 ครับ") || ($text== "COVID-19 ตอนนี้เป็นไง") || ($text== "สถานการณ์ COVID-19 ตอนนี้")){
...
ผู้รายงานข้อมูล: นายฐิติพงศ์ อ่อนจันทร์
';
		}
		else
		{
